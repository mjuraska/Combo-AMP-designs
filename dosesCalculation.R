...
numOfDosesTab1 <- tibble("rate_pla" = numeric(), "n_target_cases" = numeric(), 
...
for (i in 1:length(n_target_cases)){
  ...
  numOfDosesTab1 <- add_row(.data = numOfDosesTab1, "rate_pla" = rate_pla,
...
numOfDosesTab2 <- tibble("rate_pla" = numeric(), "n_target_cases" = numeric(), 
                         "n_ab" = numeric(), "n_pla" = numeric(),
                         "nullHR" = numeric(), "altHR" = numeric(), "tau" = numeric(), 
                         "minNumOfDoses" = numeric(),
                         "Q1NumOfDoses" = numeric(),
...
for (i in 1:length(n_target_cases)){
  ...
  numOfDosesTab2 <- add_row(.data = numOfDosesTab2, "rate_pla" = rate_pla,
                           "n_target_cases" = n_target_cases[i], 
                           "n_ab" = df$n_ab[1],
                           "n_pla" = df$n_pla[1],
                           "nullHR" = nullHR, "altHR" = altHR[i], "tau" = tau[i], 
